...
requirement starts with written goals, with the mock-up generated from them afterwards; and
everything needed to build and operate the software is versioned in the repository.

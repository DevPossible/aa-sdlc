...
| Phase | Task | Status |
|-------|------|--------|
| W | W1 to W3 | done 2026-09-22; W1 is decision record 0007 (0005 was already taken). The alpha banner W2 kept was dropped the same day at the user's request, so the banner clauses in W2 and V3 no longer apply |
...
| H | H5 | done 2026-09-22: the repository is mirrored to GitHub (DevPossible/aa-sdlc) and every page links it in the nav and footer; each step on the methodology page links its skill file |
...
| V | V3 | done 2026-09-22: website pipeline 8487 deployed commit 0ac648d; the four pages answer 200 on aasdlc.com, `/workflow` reaches the methodology page, the live `methodology.html` is byte-identical to the file the generator writes from the workflow data at 59ce81c |

...
Usage:
  ...
  aa update                                         bring everything setup and init installed up to this package version (not yet implemented)
  aa plugin  add|remove|list                        manage plugins at a scope (not yet implemented)
...
func run(args []string) int {
	...
	case "init":
		...
		return 0
	case "update", "plugin":
		fmt.Fprintf(os.Stderr, "aa %s is not implemented yet; it is planned in docs/plan-framework-gaps.md\n", args[0])
		return 2
	case "health":

...
- Guidance is cited by ID from `docs/guidance.md`. A step's own guidance is written verbatim in
  its skill; the shared guidance sets live once in `src/aa-sdlc/skills/aa-guidance/sets/` and the
  skill names the sets it reads (decision record 0012). Both are generated by

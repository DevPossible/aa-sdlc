...
.DESCRIPTION
    ...
    needs if they are missing (Node LTS for the aa CLI, Pester for the test tiers), creates the
    local working folders, and reports what it did. Safe to run repeatedly. There is no seed
    data for this repository.
.PARAMETER SkipTools
